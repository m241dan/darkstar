...
--printf("RESULT: %u",option);
	...
	elseif (csid == 0x1fe) then
		if (option == 0) then
			stock = {0x1221,1165, --Scroll of Diaga
					 0x1238,837,  --Scroll of Slow
					 0x1236,7025, --Scroll of Stoneskin

					 0x121c,140,  --Scroll of Banish
					 0x1226,1165, --Scroll of Banishga
					 0x1235,2097, --Scroll of Blink
					 0x1202,585,  --Scroll of Cure II

					 0x1237,360,  --Scroll of Aquaveil
					 0x1210,990,  --Scroll of Blindna
					 0x1207,1363, --Scroll of Curaga
					 0x1201,61,   --Scroll of Cure
					 0x1217,82,   --Scroll of Dia
					 0x120f,324,  --Scroll of Paralyna
					 0x120e,180,  --Scroll of Poisona
					 0x122b,219,  --Scroll of Protect
					 0x1230,1584} --Scroll of Shell

			showShop(player, SANDORIA, stock);
		elseif (option == 1) then
			stock = {0x12fe,111,  --Scroll of Blind

					 0x12e6,360,  --Scroll of Bio
					 0x12dc,82,   --Scroll of Poison
					 0x12fd,2250, --Scroll of Sleep

					 0x129a,324,  --Scroll of Aero
					 0x1295,1584, --Scroll of Blizzard
					 0x12eb,4644, --Scroll of Burn
					 0x12ed,2250, --Scroll of Choke
					 0x12f0,6366, --Scroll of Drown
					 0x1290,837,  --Scroll of Fire
					 0x12ec,3688, --Scroll of Frost
					 0x12ee,1827, --Scroll of Rasp
					 0x12ef,1363, --Scroll of Shock
					 0x129f,61,   --Scroll of Stone
					 0x12a4,3261, --Scroll of Thunder
					 0x12a9,140}  --Scroll of Water
