...
FISHING_GUILD_POINTS      = 2.000; -- Multiplies guild points earned from fishermans' guild trades.
WOODWORKING_GUILD_POINTS  = 2.000; -- Multiplies guild points earned from carpenters' guild trades.
SMITHING_GUILD_POINTS     = 2.000; -- Multiplies guild points earned from blacksmiths' guild trades.
GOLDSMITHING_GUILD_POINTS = 2.000; -- Multiplies guild points earned from goldsmiths' guild trades.
CLOTHCRAFT_GUILD_POINTS   = 2.000; -- Multiplies guild points earned from weavers' guild trades.
LEATHERCRAFT_GUILD_POINTS = 2.000; -- Multiplies guild points earned from tanners' guild trades.
BONECRAFT_GUILD_POINTS    = 2.000; -- Multiplies guild points earned from boneworkers' guild trades.
ALCHEMY_GUILD_POINTS      = 2.000; -- Multiplies guild points earned from alchemists' guild trades.
COOKING_GUILD_POINTS      = 2.000; -- Multiplies guild points earned from culinarians' guild trades.
...
HARVESTING_BREAK_CHANCE = 0.13; -- % chance for the sickle to break during harvesting.  Set between 0 and 1.
EXCAVATION_BREAK_CHANCE = 0.13; -- % chance for the pickaxe to break during excavation.  Set between 0 and 1.
LOGGING_BREAK_CHANCE    = 0.13; -- % chance for the hatchet to break during logging.  Set between 0 and 1.
MINING_BREAK_CHANCE     = 0.13; -- % chance for the pickaxe to break during mining.  Set between 0 and 1.
...
MINING_RATE             = 0.70; -- % chance to recieve an item from mining.  Set between 0 and 1.
...
-- DYNAMIS SETTINGS
    ...
    TIMELESS_HOURGLASS_COST = 100000;   -- cost of the timeless hourglass for Dynamis.
