    ...
    ************************************************************************/
    ...
    void LoadChar(CCharEntity* PChar)
    {
            ...
            Sql_NextRow(SqlHandle) == SQL_SUCCESS)
        {
            ...
            PChar->getStorage(LOC_WARDROBE2)->AddBuff(80);
            PChar->getStorage(LOC_WARDROBE3)->AddBuff(80);
            PChar->getStorage(LOC_WARDROBE4)->AddBuff(80);
        }
            ...
            if (baseexp != 0)
            {
                if (PMember->getZone() == PMob->getZone())
                {
                    ...
                    if (PMember->StatusEffectContainer->HasStatusEffect(EFFECT_SIGNET) && (region >= 0 && region <= 22))
                    {
                        switch (pcinzone)
                        {
                            switch (pcinzone)
                            {
                                ...
                                case 2: exp *= 0.85f; break;
                                case 3: exp *= 0.65f; break;
                                case 4: exp *= 0.55f; break;
                                case 5: exp *= 0.49f; break;
                    ...
                    else if (PMember->StatusEffectContainer->HasStatusEffect(EFFECT_SANCTION) && (region >= 28 && region <= 32))
                    {
                        switch (pcinzone)
                        {
                            case 1: exp *= 1.35f; break;
                            case 2: exp *= 1.10f; break;
                            case 3: exp *= 0.90f; break;
                            case 4: exp *= 0.80f; break;
                            case 5: exp *= 0.74f; break;
                            case 6: exp *= 0.70f; break;
